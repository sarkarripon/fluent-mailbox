...
const fetchEmails = async () => {
    loading.value = true;
    try {
        const response = await api.getEmails(1, 'all'); // 'all' technically includes sent, but for Inbox we might want 'inbox' if we had receiving working. For now, showing all.
