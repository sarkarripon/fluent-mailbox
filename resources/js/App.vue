<template>
  <div class="flex h-screen bg-gray-50 font-sans text-gray-900">
    ...
    <aside class="w-64 bg-white border-r border-gray-200 flex flex-col">
      ...
      <div class="px-4 mb-6">
          <button @click="showCompose = true" class="w-full flex items-center justify-center space-x-2 bg-blue-600 hover:bg-blue-700 text-white py-3 px-4 rounded-xl shadow-md transition-all duration-200 font-medium">
